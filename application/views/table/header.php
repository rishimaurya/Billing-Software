...
.dropdown:hover .dropdown-content {
   ...
   <li class="active"><a href="<?php echo base_url('Customer');?>">Add Customer</a></li>
        <li class="active"><a href="<?php echo base_url('Customer/searchCustomerList');?>">Customer List</a></li>      <li class="active"><a href="<?php echo base_url('Agency');?>">Add Agency</a></li>
